...
public class MenuPrincipalActivity extends AppCompatActivity {
    ...
    private Button btnHorario, btnUsuarios, btnAgregar, btnHistoria;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHistoria = findViewById(R.id.btnHistoria); // NUEVO
        ...
        btnHistoria.setOnClickListener(v -> startActivity(new Intent(this, HistoriaDesarrolladoresActivity.class))); // NUEVO
    }
}
